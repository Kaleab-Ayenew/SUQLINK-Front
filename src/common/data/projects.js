...
const projects = [
  {
    ...
    files: [
      { name: "BlackStorm Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "BlackStorm Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "BlackStorm Logo.Zip", size: "2.02 MB", link: "#" },
