...
// // Product Edit Pages
import MyProductEditpPage from "../pages/product-edit";
import MyProductInfoPage from "../pages/product-dash";
import MyProductList from "../pages/my-product-view";

// // Social Login
import SocialLink from "../pages/my-social-link";

const authProtectedRoutes = [
  // // kal: My New Routes
  { path: "/products", component: <MyProductEditpPage /> },
  { path: "/products/:slug", component: <MyProductEditpPage edit={true} /> },
  // // kal: Product Info Page Experminets
  { path: "/product-dash", component: <MyProductInfoPage /> },
  { path: "/product-list", component: <MyProductList /> },
  // // kal: Social Login Pages
  { path: "/social-link", component: <SocialLink /> },
  ...
  { path: "/", exact: true, component: <Navigate to="/product-dash" /> },
];
