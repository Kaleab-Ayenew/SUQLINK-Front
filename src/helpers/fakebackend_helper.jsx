...
import { del, get, post, put, kal_post } from "./api_helper";
...
// Login Method
// kal: API LOGIN URL HAS BEEN CHANGED HERE
// const postFakeLogin = (data) => post(url.POST_REAL_API_LOGIN, data);
const postFakeLogin = (data) => kal_post(url.POST_REAL_API_LOGIN, data);
const postRealAPILogin = (data) => kal_post(url.POST_REAL_API_LOGIN, data);
